...
// OJO un php puro No permite <!-- Comentario --> antes del <?php
	...
	IF(!$_SESSION["autentificado"]) { // Se setea en control.php  ;  No autentificado  ;  $_SESSION["nombre_cualquiera"]
		header("Location: ../Proyecto_Instituto_Gestion/index.php"); // header Llama a otro php ; Vuelve a pagina inicial sin enviar parametro ?error=si ; envia encabezado sin formato HTTP
