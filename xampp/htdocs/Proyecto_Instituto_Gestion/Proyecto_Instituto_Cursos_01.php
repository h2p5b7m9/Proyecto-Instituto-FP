...
echo "<body>" . "\n";
echo "<p align=center><br><br><br><br><br><br><br><br><br><FONT COLOR=purple>iFP pone a tu disposición una completa oferta de ciclos formativos con titulación oficial adaptada a las necesidades del mercado y las empresas.<br>" . "\n";
echo "</FONT><br><br></p>" . "\n";

echo "<table class='table1' border=8 style='width:80%' align=center cellpadding='5px' cellspacing='0px'>" . "\n";
echo "<tr>" . "\n";
echo "<td class='td1'><center><b><FONT size=3><a href='Proyecto_Instituto_Cursos_Comercio_Internacional.php'>COMERCIO INTERNACIONAL</a></FONT><BR><FONT size=1>GRADO SUPERIOR</FONT></b></center>" . "\n";
echo "</td>" . "\n";
...
echo "</td>" . "\n";
echo "<td class='td1'><br><center><b><FONT size=3><a href='Proyecto_Instituto_Cursos_Comercio_Internacional.php'>COMERCIO INTERNACIONAL</a> + <a href='Proyecto_Instituto_Cursos_Transporte_y_Logística.html'>TRANSPORTE Y LOGÍSTICA</a></FONT><BR><FONT size=1>DOBLE GRADO SUPERIOR</FONT></b></center><br> " . "\n";
echo "</td>" . "\n";
...
echo "<br><br>" . "\n";
echo "<br>" . "\n";
echo "<p align=center><FONT size=5 COLOR=purple><b>Campus virtual</b></FONT>" . "\n";
echo "</p>" . "\n";
...
echo "</p>" . "\n";
echo "<img src='Proyecto_Instituto_Imagenes/Bienvenido al campus virtual.jpg'>" . "\n";
echo "</center>" . "\n";
