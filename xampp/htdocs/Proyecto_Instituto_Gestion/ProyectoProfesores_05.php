<?php
//KKK3 No se ha podido actualizar el registro con los datos especificados.
//KKK1
// http://localhost/Proyecto_Instituto_Gestion/index.php
// Depurar: Quitar session http://localhost/Proyecto_Instituto_Gestion/ProyectoProfesores_02.php
// Buscar session
...
KKK2 Mantenimiento de profesores Lista de todos los profesores ; Alta de profesor ; Modificación de profesores
*/
...
function mostrarTodosProfesores() {
   ...
   $equipo = "sql304.260mb.net"; // localhost
   $usuario = "n260m_23566769"; // root
   $contra = "Eur8pM1D"; // ""
   $base_datos = "n260m_23566769_proyecto"; // Proyecto ; Proyecto.sql exportar en phpmyadmin xampp servidor
            ...
            if($resultado->num_rows > 0) { //Metodo num_rows ; Registros encontrados
                echo"<table border='3' align='center' style='width:98%'>
                 <tr bgcolor='turquoise'> <!-- #E6E6E6, turquoise, aquamarine, cyan, pink, cornsilk -->
                    ...
                    <th>Teléfono</th>
                    <th>Sexo</th>
                    <th>Dirección Lín. 1</th>
                    <th>Dirección Lín. 2</th>
                    <th>Ciudad</th>
                    <th>Región</th>
                    <th>País</th>
                    <th>Código Postal</th>
...
//$Id_Profesor = $_POST["Id_Profesor"];
   ...
   $cabeceras_tabla_array = Array("Código de profesor", "Nombre de profesor", "Apellidos", "Experiencia", "Formación", "Doctorado", "Teléfono", "Sexo", "Línea 1 Dirección", "Línea 2 Dirección", "Ciudad", "Región", "País", "Código Postal"); // Array
...
//$Id_Profesor = $_POST["Id_Profesor"];
   ...
   //$campos_tabla_array = array("id_Profesor", "nombre", "apellido", "experiencia", "formacion", "doctorado", "telefono", "sexo", "lineaDireccion1", "lineaDireccion2", "ciudad", "region", "pais", "codigoPostal"); // Array
   $cabeceras_tabla_array = Array("Código", "Nombre", "Apellidos", "Experiencia", "Formación", "Doctorado", "Teléfono", "Sexo", "Línea 1 Dirección", "Línea 2 Dirección", "Ciudad", "Región", "País", "Código Postal"); // Array
   ...
   else
   {
    ...
    // Ver pgm086.php input table Tabla de entrada si hay varios registros con Id_Profesor repetido
        ...
        *********/
        ...
        echo '<td><input type="text" style="background-color:' . $row_color[$color_index] . '" size="8" value="' . $fila["Id_Profesor"] . '" name="' . $campos_tabla_array[0] . "_" . $fila["Id_Profesor"] . '"></td>'; // OJO El value empieza por Mayuscula y el name por Minuscula ; Sustituyo name por array
        echo '<td><input type="text" style="background-color:' . $row_color[$color_index] . '" size="8" value="' . $fila["Nombre"] . '" name="' . $campos_tabla_array[1] . "_" . $fila["Id_Profesor"] . '"></td>';
        echo '<td><input type="text" style="background-color:' . $row_color[$color_index] . '" size="16" value="' .  $fila["Apellido"] . '" name="' . $campos_tabla_array[2] . "_" . $fila["Id_Profesor"] . '"></td>';
...
//function validarErrores01() {
//document.write("<b>No hay registros con la selección especificada.</b><br>");
echo "alert('No hay registros con la selección especificada.')";
//}
echo "</script>";
                //KKK1 FIN
...
header('Content-Type: text/html; charset=ISO-8859-1'); //En localhost van bien los acentos, pero el hosting 260mb.net no y necesita este header ; UTF-8 ; Ver php header charset utf-8 ISO-8859-1.txt
...
//echo "<br />" . "\n";
//echo "<a href='salir.php'>Cerrar Sesion</a> </p>" . "\n";



echo "<table border=0 style='width:54%' align=right cellpadding='0px' cellspacing='0px'>" . "\n";
echo "<tr>" . "\n";
echo "<td bgcolor='lightblue'><img src='Proyecto_Instituto_Imagenes/IFP.jpg'> </td>" . "\n";
echo "<td bgcolor='lightblue'> <p class='color_azul' align=right>Logged in Usuario: " . $_SESSION['nombre'] . "\n"; // $_SESSION Corchete  ; Muestra session nombre guardado en control.php
echo "<br />" . "\n";
...
echo "<table border=0 style='width:92%' align=right cellpadding='0px' cellspacing='0px'>" . "\n";
echo "<tr>" . "\n";
echo "<td bgcolor='lightblue'> <center><FONT size=3 COLOR='#0000FF'><h2><b><u>Control de faltas de asistencia por UF</u></b></h2></FONT></center> </td>" . "\n";
echo "<td bgcolor='lightblue'> <p class='color_azul' align=right> <a href='Proyecto_Instituto.php'>Inicio</a></p>" . "\n";
echo "</td>" . "\n";
echo "</tr>" . "\n";
echo "</table>" . "\n";
...
echo "<center>" . "\n";
//echo "<img src='Proyecto_Instituto_Imagenes/IFP.jpg' /> " . "\n";
//echo "<h5 id='font_size_1' class='color_purpura h_5'>Control de faltas de asistencia por UF</h5> " . "\n";
//echo "<p align=right><a href='Proyecto_Instituto.php'><FONT size=4 color=green>Inicio</FONT></a></p>" . "\n";

if (!$_POST){ // Si no ha pulsado clicado ningun boton
   echo "<br><br><br><br><br><br><br><br><p id='font_size_2'><u>Mantenimiento de profesores</u></p>" . "\n"; //KKK2
}
   ...
   if(isset($_POST['accion']) && $_POST['accion'] == 'mostrar_todos'){ // input type="hidden" name="accion"  ;  Si ha pulsado clicado boton MOSTRAR_TODOS
      echo "<br><br><br><br><br><br><br><br><p id='font_size_2'><u>Lista de todos los profesores</u></p>" . "\n";
   }
   if(isset($_POST['accion']) && $_POST['accion'] == 'alta_profesor'){ // input type="hidden" name="accion"  ;  Si ha pulsado clicado boton ALTA_PROFESOR
      echo "<br><br><br><br><br><br><br><br><p id='font_size_2'><u>Alta de profesor</u></p>" . "\n";
   }
   if(isset($_POST['accion']) && $_POST['accion'] == 'buscar_profesor'){ // input type="hidden" name="accion"  ;  Si ha pulsado clicado boton BUSCAR_PROFESOR
      if($_POST["Id_Profesor"] || $_POST["Nombre"] || $_POST["Apellido"] || $_POST["Experiencia"]) {
      echo "<br><br><br><br><br><br><br><br><p id='font_size_2'><u>Modificación de profesores</u></p>" . "\n";
      }
   }
}
...
echo "<form method='POST' action=" . $_SERVER['PHP_SELF'] . ">" . "\n";
echo "<input type='hidden' name='accion' value='mostrar_todos'>" . "\n";
...
echo "<input type='submit' value='Mostrar todos' class='color_azul' /><br>" . "\n";
echo "</form>" . "\n";
...
/*
   ...
   //if(isset($_POST['accion']) && $_POST['accion'] == 'buscar_profesor' && $habilitar_mostrar_todos){ // input type="hidden" name="accion"  ;  Si ha pulsado clicado boton BUSCAR_PROFESOR
      echo '<input type="submit" value="Mostrar todos" disabled /><br><br> ';
   }
   else {
      echo '<input type="submit" value="Mostrar todos" /><br><br> ';
   }
*/
...
/*       <!--
       ...
       --> */
echo "<form method='POST' action=" . $_SERVER['PHP_SELF'] . ">" . "\n";
echo "<br><input type='hidden' name='accion' value='alta_profesor'>" . "\n";
//echo "<input type='hidden' name='msg' value=" . htmlspecialchars(serialize($msg), ENT_QUOTES) . " />" . "\n";
echo "<input type='submit' value='Alta de profesor' class='color_verde' /><br><br>" . "\n";
echo "</form>" . "\n";
...
echo "<form method='POST' action=" . $_SERVER["PHP_SELF"] . ">" . "\n";
echo "Código de profesor: <input type='text' name='Id_Profesor' size='5'>" . "\n";
echo "&nbsp; Nombre de profesor: <input type='text' name='Nombre'> " . "\n";
echo "&nbsp; Apellidos: <input type='text' name='Apellido'>" . "\n";
...
//echo "<input type='hidden' name='msg' value='" . htmlspecialchars(serialize($msg), ENT_QUOTES) . "' /> " . "\n";
echo "<input type='submit' value='Buscar profesor' name='buscar_profesor' class='color_marron' /> <br><br> " . "\n";
...
echo "<form method='POST' action=" . $_SERVER["PHP_SELF"] . ">" . "\n";
echo "Código de profesor: <input type='text' name='Id_Profesor'> &nbsp; " . "\n";
echo "<input type='hidden' name='accion' value='eliminar_profesor'> " . "\n";
//echo "<input type='hidden' name='msg' value=" . htmlspecialchars(serialize($msg), ENT_QUOTES) . " /> " . "\n";
echo "<input type='submit' value='Eliminar profesor' class='color_rojo' /><br><br>" . "\n";
