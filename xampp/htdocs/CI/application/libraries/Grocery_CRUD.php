<?php
//http://localhost/CI/index.php/examples
//Buscar debug Mío
//Buscar KKK
//Buscar foreach
// Buscar .js
 ...
 */
class grocery_CRUD_Field_Types { // class0
	/**
...
/*
public function debug($lin_debug){
   //$this->debug("libraries-Grocery_CRUD-");
...
*/
	...
	public function get_field_types(){
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()");
		if ($this->field_types !== null) {
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-001");
	   ...
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-002");
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-003 - in_array(field_info->name, this->required_fields) = " . in_array($field_info->name, $this->required_fields)); //in_array(String_A_Buscar, Array)
	   }
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-004 - field_info->name = " . $field_info->name);
			$field_info->required = !empty($this->required_fields) && in_array($field_info->name, $this->required_fields) ? true : false; //in_array(String_A_Buscar, Array)

      if(isset($this->display_as[$field_info->name])) {
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-005 - this->display_as[field_info->name] = " . $this->display_as[$field_info->name]);
	   }
			$field_info->display_as =
				isset($this->display_as[$field_info->name]) ?
					$this->display_as[$field_info->name] :
					ucfirst(str_replace("_", " ", $field_info->name)); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)

	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-006 - field_info->display_as = " . $field_info->display_as); //CustomerNumber

			//if(isset($this->change_field_type[$field_info->name])) {
	   //$this->debug("libraries-Grocery_CRUD - this->change_field_type[field_info->name] = " . $this->change_field_type[$field_info->name]); //KKK Error: Array to string conversion
			//}

			if($this->change_field_type !== null && isset($this->change_field_type[$field_info->name]))
			{
	   //$this->debug("libraries-Grocery_CRUD - this->change_field_type = " . $this->change_field_type); //KKK Error Array to string conversion
				$field_type 			= $this->change_field_type[$field_info->name];
	   //$this->debug("libraries-Grocery_CRUD - this->change_field_type[field_info->name] = " . $this->change_field_type[$field_info->name]); //KKK Error Array to string conversion
	   //$this->debug("libraries-Grocery_CRUD - field_type = " . $field_type); //KKK Error Array to string conversion

				if (isset($this->relation[$field_info->name])) {
					$field_info->crud_type = "relation_".$field_type->type;
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-007 - field_info->crud_type = " . $field_info->crud_type);
	   //$this->debug("libraries-Grocery_CRUD - this->relation[field_info->name] = " . $this->relation[$field_info->name]); //KKK Error Array to string conversion
				}
				elseif (isset($this->upload_fields[$field_info->name])) {
					$field_info->crud_type = "upload_file_".$field_type->type;
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-008 - field_info->crud_type = " . $field_info->crud_type);
				}
				else {
					$field_info->crud_type 	= $field_type->type;
					$field_info->extras 	=  $field_type->extras;
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-009 - field_info->crud_type = " . $field_info->crud_type);
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-010 - field_info->extras = " . $field_info->extras);
				}

				$real_type				= $field_info->crud_type;
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-011- real_type = " . $real_type);
			}
			elseif(isset($this->relation[$field_info->name]))
			{
				$real_type				= 'relation';
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-012 - real_type = " . $real_type);
				$field_info->crud_type 	= 'relation';
			}
			elseif(isset($this->upload_fields[$field_info->name]))
			{
				$real_type				= 'upload_file';
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-013 -real_type = " . $real_type);
				$field_info->crud_type 	= 'upload_file';
			}
			else
			{
				$real_type = $this->get_type($field_info);
	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-014 -real_type = " . $real_type);
				$field_info->crud_type = $real_type;
			}

	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-015");

        if(!empty($real_type)){
 	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-016 -real_type = " . $real_type);
       }

			switch ($real_type) {
				case 'text':
 	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-017");
					if(!empty($this->unset_texteditor) && in_array($field_info->name, $this->unset_texteditor)) { //in_array(String_A_Buscar, Array)
 	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-018");
						$field_info->extras = false;
					}
					else{
 	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-019");
 	   ...
 	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-020");
					$field_info->extras 	= $this->relation[$field_info->name];
				break;

				case 'upload_file':
				case 'upload_file_readonly':
 	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-021");
					$field_info->extras 	= $this->upload_fields[$field_info->name];
				break;

				default:
 	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-022");
					if(empty($field_info->extras)){
 	   $this->debug("libraries-Grocery_CRUD-public function get_field_types()-023");
						$field_info->extras = false;
					}
				break;
			} //switch
		...
		{
	   //$this->debug("libraries-Grocery_CRUD-public function get_field_types()-024 - $this->relation_n_n = " . $this->relation_n_n); //Error: Array to string conversion
	   ...
	   //$this->debug("libraries-Grocery_CRUD - field_extras = " . $field_extras);
				$field_info->extras 	= $field_extras;
	   //$this->debug("libraries-Grocery_CRUD-public function get_field_types()-025 - field_info->extras = " . $field_info->extras);
				$field_info->required	= !empty($this->required_fields) && in_array($field_name, $this->required_fields) ? true : false;; //in_array(String_A_Buscar, Array)

				if(!empty($this->required_fields) && in_array($field_name, $this->required_fields)){ //in_array(String_A_Buscar, Array)
	            $this->debug("libraries-Grocery_CRUD-public function get_field_types()-026 - this->required_fields = " . $this->required_fields);
				}

				$field_info->display_as =
					isset($this->display_as[$field_name]) ?
						$this->display_as[$field_name] :
						ucfirst(str_replace("_", " ", $field_name)); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)

            if(isset($this->display_as[$field_name])){
	            $this->debug("libraries-Grocery_CRUD-public function get_field_types()-027- this->display_as[field_name] = " . $this->display_as[$field_name]);
         }
	  ...
	  $this->debug("libraries-Grocery_CRUD-public function get_field_types()-028");
		if(!empty($this->add_fields)) {
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-029");
			foreach($this->add_fields as $field_object)
			{
				$field_name = isset($field_object->field_name) ? $field_object->field_name : $field_object;
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-030");

				if(!isset($types[$field_name]))//Doesn't exist in the database? Create it for the CRUD
				{
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-031");
					$extras = false;
					if($this->change_field_type !== null && isset($this->change_field_type[$field_name]))
					{
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-032");
					...
					$field_info = (object)array(
						...
						'extras'	=> $extras
					); //in_array(String_A_Buscar, Array)  ;  str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)

	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-033");
					$types[$field_name] = $field_info;
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-034");
				}
			}
		}

	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-035");
		if(!empty($this->edit_fields)){
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-036");
			foreach($this->edit_fields as $field_object)
			{
				$field_name = isset($field_object->field_name) ? $field_object->field_name : $field_object;
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-037");

				if(!isset($types[$field_name]))//Doesn't exist in the database? Create it for the CRUD
				{
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-038");
					$extras = false;
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-039");
					if($this->change_field_type !== null && isset($this->change_field_type[$field_name]))
					{
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-040");
						$field_type = $this->change_field_type[$field_name];
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-041");
						$extras 	=  $field_type->extras;
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-042");
					}
	      ...
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-043");

					$types[$field_name] = $field_info;
	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-044");
				}
			} //foreach
		}

	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-045");

		$this->field_types = $types;

	      $this->debug("libraries-Grocery_CRUD-public function get_field_types()-046");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function get_primary_key()-001");
   $this->debug("libraries-Grocery_CRUD-public function get_primary_key()-002- this->basic_model->get_primary_key() = " . $this->basic_model->get_primary_key());
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_field_input(field_info, value = null)-001");
			$real_type = $field_info->crud_type;
   $this->debug("libraries-Grocery_CRUD-protected function get_field_input(field_info, value = null)-002 - field_info->crud_type = " . $field_info->crud_type);
			...
			if (in_array($real_type, $types_array)) { //in_array(String_A_Buscar, Array)
				 ...
				 *  */
   $this->debug("libraries-Grocery_CRUD-protected function get_field_input(field_info, value = null)-003");
				$field_info->input = $this->{"get_" . $real_type . "_input"}($field_info, $value);
			}
			else
			{
   $this->debug("libraries-Grocery_CRUD-protected function get_field_input(field_info, value = null)-004");
				$field_info->input = $this->get_string_input($field_info, $value);
			}
   $this->debug("libraries-Grocery_CRUD-protected function get_field_input(field_info, value = null)-005 - field_info->input = " . $field_info->input);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-001");
		$real_type = $field_info->crud_type;
		switch ($real_type) {
			case 'hidden':
			case 'invisible':
			case 'integer':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-002");

			break;
			case 'true_false':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-003");
				if(is_array($field_info->extras) && array_key_exists($value,$field_info->extras)) {
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-004");
					$value = $field_info->extras[$value];
				} else if(isset($this->default_true_false_text[$value])) {
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-005");
					$value = $this->default_true_false_text[$value];
				}
			break;
			case 'string':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-006");
				$value = $this->character_limiter($value, $this->character_limiter, "...");
			break;
			case 'text':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-007");
				$value = $this->character_limiter(strip_tags($value), $this->character_limiter, "...");
			break;
			case 'date':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-008");
				if(!empty($value) && $value != '0000-00-00' && $value != '1970-01-01')
				{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-009");
					list($year,$month,$day) = explode("-",$value); //list Asigna de array a variables
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-010");

					$value = date($this->php_date_format, mktime (0, 0, 0, (int)$month , (int)$day , (int)$year));
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-011");
				}
				else
				{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-012");
					$value = '';
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-013-value=" . $value);
				}
			break;
			case 'datetime':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-014");
				if(!empty($value) && $value != '0000-00-00 00:00:00' && $value != '1970-01-01 00:00:00')
				{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-015");
					list($year,$month,$day) = explode("-",$value); //list Asigna de array a variables
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-016");
					list($hours,$minutes) = explode(":",substr($value,11)); //list Asigna de array a variables
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-017");

					$value = date($this->php_date_format." - H:i", mktime ((int)$hours , (int)$minutes , 0, (int)$month , (int)$day ,(int)$year));
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-018");
				}
				else
				{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-019");
					$value = '';
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-020-value=" . $value);
				}
			break;
			case 'enum':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-021");
				$value = $this->character_limiter($value, $this->character_limiter, "...");
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-022");
			break;

			case 'multiselect':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-023");
				$value_as_array = array();
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-024");
   ...
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-025");
			break;

			case 'relation_n_n':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-026");
				$value = $this->character_limiter(str_replace(',', ', ' ,$value),$this->character_limiter,"..."); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-027");
			break;

			case 'password':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-028");
				$value = '******';
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-029");
			break;

			case 'dropdown':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-030");
				$value = array_key_exists($value,$field_info->extras) ? $field_info->extras[$value] : $value;
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-031");
			break;

			case 'upload_file':
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-032");
				if(empty($value))
				{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-033");
					$value = "";
				}
				else
				{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-034");
					...
					(substr($value,-4) == '.jpg'
							...
							|| substr($value, -5) == '.tiff')
							? true : false;
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-035");

					$file_url = base_url().$field_info->extras->upload_path."/$value";
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-036");

					$file_url_anchor = '<a href="' . $file_url . '"';
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-037");
					if($is_image)
					{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-038");
						$file_url_anchor .= ' class="image-thumbnail"><img src="'.$file_url.'" height="50px">';
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-039");
					}
					else
					{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-040");
						$file_url_anchor .= ' target="_blank">'.$this->character_limiter($value,$this->character_limiter,'...',true);
					}
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-041");
					$file_url_anchor .= '</a>';
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-042");

					$value = $file_url_anchor;
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-043");
				}
			break;

			default:
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-044");
				$value = $this->character_limiter($value, $this->character_limiter, "...");
   $this->debug("libraries-Grocery_CRUD-protected function change_list_value(field_info, value = null)-045");
			break;
		}
	...
	{
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-001");
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-002- str =" . $str);
		if (strlen($str) < $n)
		{
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-003");
			return $str;
		}
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-004");

		// a bit complicated, but faster than preg_replace with \s+
		$str = preg_replace('/ {2,}/', ' ', str_replace(array("\r", "\n", "\t", "\x0B", "\x0C"), ' ', $str)); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-005");

		if (strlen($str) <= $n)
		{
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-006");
			return $str;
		}
		...
		{
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-007-val = " . $val);
			$out .= $val.' ';

			if (strlen($out) >= $n)
			{
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-008");
				$out = trim($out);
   $this->debug("libraries-Grocery_CRUD-function character_limiter(str, n = 500, end_char = '&#8230;')-009- out = " . $out);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-001");
		$type = false;
		if(!empty($db_type->type))
		{
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-002- db_type->type = " . $db_type->type);
			switch ($db_type->type) {
				case '1':
				case '3':
				case 'int':
				...
				case 'mediumint':
				case 'longint':
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-003");
					if( $db_type->db_type == 'tinyint' && $db_type->db_max_length ==  1){
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-004");
						$type = 'true_false';
					}
					else{
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-005");
						$type = 'integer';
					}
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-006");
				break;
				case '254':
				case 'string':
				case 'enum':
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-007");
					if($db_type->db_type != 'enum'){
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-008");
						$type = 'string';
					}
					else{
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-009");
						$type = 'enum';
					}
				break;
				case 'set':
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-010");
					if($db_type->db_type != 'set'){
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-011");
						$type = 'string';
					}
					else{
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-012");
						$type = 'set';
					}
				break;
				case '252':
				...
				case 'mediumtext':
				case 'longtext':
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-013");
					$type = 'text';
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-014-type = " . $type);
				break;
				case '10':
				case 'date':
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-015");
					$type = 'date';
				break;
				case '12':
				case 'datetime':
				case 'timestamp':
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-016");
					$type = 'datetime';
				break;
			}
		}
   $this->debug("libraries-Grocery_CRUD-protected function get_type(db_type)-017");
		return $type;
	}
} //class grocery_CRUD_Field_Types - class0
 ...
 * @link		http://www.grocerycrud.com/documentation
 */
class grocery_CRUD_Model_Driver extends grocery_CRUD_Field_Types // class0
{
	/**
...
*/
   ...
   $this->debug("libraries-Grocery_CRUD-protected function set_default_Model()-001");
		$ci = &get_instance();
   $this->debug("libraries-Grocery_CRUD-protected function set_default_Model()-002");
		$ci->load->model('Grocery_crud_model');
   $this->debug("libraries-Grocery_CRUD-protected function set_default_Model()-003");

		$this->basic_model = new Grocery_crud_model();
   $this->debug("libraries-Grocery_CRUD-protected function set_default_Model()-004");
	}

	protected function get_total_results(){
   $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-001");
		if(!empty($this->where)) { //public function where( definido en  D:\xampp\htdocs\CI\system\database\DB_query_builder.php
   $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-002-this->where = ". $this->where);
			foreach($this->where as $where) {
				$this->basic_model->where($where[0], $where[1], $where[2]);
            $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-003-where = " . $where);
			}
		}

		if(!empty($this->or_where)) { //public function or_where( definido en  D:\xampp\htdocs\CI\system\database\DB_query_builder.php
   $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-003-this->or_where=" . $this->or_where);
			foreach($this->or_where as $or_where){
				$this->basic_model->or_where($or_where[0], $or_where[1], $or_where[2]);
            $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-004-or_where = " . $or_where);
			}
		}

		if(!empty($this->like)) { //public function like( definido en  D:\xampp\htdocs\CI\system\database\DB_query_builder.php
         $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-005-this->like = " . $this->like);
			foreach($this->like as $like) {
            $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-006-like = " . $like);
				$this->basic_model->like($like[0], $like[1], $like[2]);
			}
		}

		if(!empty($this->or_like)) { //public function or_like( definido en  D:\xampp\htdocs\CI\system\database\DB_query_builder.php
         $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-007-this->or_like = " . $this->or_like);
			foreach($this->or_like as $or_like) {
            $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-008-or_like = " . $or_like);
				$this->basic_model->or_like($or_like[0], $or_like[1], $or_like[2]);
			}
		}

		if(!empty($this->having)) { //public function having( definido en  D:\xampp\htdocs\CI\system\database\DB_query_builder.php
         $this->debug("libraries-Grocery_CRUD-protected function get_total_results()-009-this->having = " . $this->having);
			foreach($this->having as $having) {
				$this->basic_model->having($having[0],$having[1],$having[2]);
			}
		}

		if(!empty($this->or_having)) { //public function or_having( definido en  D:\xampp\htdocs\CI\system\database\DB_query_builder.php
   ...
   $this->debug("libraries-Grocery_CRUD-protected function filter_data_from_xss(post_data)-001");
   ...
   $this->debug("libraries-Grocery_CRUD-public function set_model(model_name)");
		$ci = &get_instance();
		$ci->load->model('Grocery_crud_model');
   ...
   $this->debug("libraries-Grocery_CRUD-protected function set_ajax_list_queries(state_info = null)");
   ...
   $this->debug("libraries-Grocery_CRUD-protected function table_exists(table_name = null)");
   ...
   $this->debug("libraries-Grocery_CRUD-protected function get_relation_array(relation_info, primary_key_value = null, limit = null)");
		list($field_name , $related_table , $related_field_title, $where_clause, $order_by)  = $relation_info; //list Asigna de array a variables
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_relation_total_rows(relation_info)");
		list($field_name , $related_table , $related_field_title, $where_clause)  = $relation_info; //list Asigna de array a variables
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function db_insert_validation()");
		...
		if(!empty($required_fields))
		{
			foreach($add_fields as $add_field)
			{
				...
				if(!isset($this->validation_rules[$field_name]) && in_array( $field_name, $required_fields) ) //in_array(String_A_Buscar, Array)
				{
		...
		if(!empty($unique_fields))
		{
			...
			{
				$field_name = $add_field->field_name;
				if(in_array($field_name, $unique_fields)) //OJO in_array(String_A_Buscar, Array) //in_array(String_A_Buscar, Array)
				{
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function form_validation()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function db_update_validation()");
		$validation_result = (object)array('success'=>false);
		...
		if(!empty($unique_fields))
		{
			...
			{
				$field_name = $edit_field->field_name;
				if(in_array($field_name, $unique_fields) ) //in_array(String_A_Buscar, Array)
				{
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function db_insert(state_info)");
   $this->debug("state_info=" . $state_info);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function db_update(state_info)");
   $this->debug("state_info=" . $state_info);
				...
				if(!empty($this->relation_n_n))
				{
					foreach($this->relation_n_n as $field_name => $field_info)
					{
						if ($this->unset_edit_fields !== null
							...
							&& in_array($field_name, $this->unset_edit_fields) //in_array(String_A_Buscar, Array)
						) {
								continue;
						}
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _convert_date_to_sql_date(date");
   $this->debug("libraries-Grocery_CRUD-date = " . $date);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _get_field_names_to_search(array relation_values)");
		if(!strstr($relation_values[2],'{')) {
			...
			foreach($temp1 as $field) {
				list($field_name) = explode('}', $field); //list Asigna de array a variables
    ...
    {
   $this->debug("libraries-Grocery_CRUD-protected function _unique_join_name(field_name)");
    ...
    {
   $this->debug("libraries-Grocery_CRUD-protected function _unique_field_name(field_name)");
    ...
    {
   $this->debug("libraries-Grocery_CRUD-protected function db_multiple_delete(state_info)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function db_delete(state_info)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function db_relation_n_n_update(field_info, post_data , primary_key_value)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function db_relation_n_n_delete(field_info, primary_key_value)");
		$this->basic_model->db_relation_n_n_delete($field_info, $primary_key_value);
	}

	protected function get_list()
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_list()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_edit_values(primary_key_value)");
    ...
    {
   $this->debug("libraries-Grocery_CRUD-protected function get_clone_values(primary_key_value)");
        $values = $this->basic_model->get_edit_values($primary_key_value);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_relation_n_n_selection_array(primary_key_value, field_info)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_relation_n_n_unselected_array(field_info, selected_values)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function set_basic_db_table(table_name = null)");
		$this->basic_model->set_basic_table($table_name);
	}

	protected function upload_file($state_info)
	{
   $this->debug("libraries-Grocery_CRUD-protected function upload_file(state_info)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function delete_file(state_info)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function ajax_relation(state_info)");
		if(!isset($this->relation[$state_info->field_name]))
			return false;

		list($field_name, $related_table, $related_field_title, $where_clause, $order_by)  = $this->relation[$state_info->field_name]; //list Asigna de array a variables
 ...
 * @version    	1.6.1
 */
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver // class0
{
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function set_basic_Layout()");
   ...
   $this->debug("libraries-Grocery_CRUD-protected function showList(ajax = false, state_info = null)");
   $this->debug("libraries-Grocery_CRUD-protected function showList(ajax = false, state_info = null) - ajax = " . $ajax);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function exportToExcel(state_info = null)");
		$data = $this->get_common_data();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _export_to_excel(data)");
   //$this->debug("libraries-Grocery_CRUD-data = " . $data);
		/**
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function print_webpage(state_info = null)");
		$data = $this->get_common_data();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _print_webpage(data)");
   $this->debug("libraries-Grocery_CRUD-protected function _print_webpage(data) - data = " . $data);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _trim_export_string(value)");
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
		$value = str_replace(array("&nbsp;","&amp;","&gt;","&lt;"), array(" ","&",">","<"), $value); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
		return  strip_tags(str_replace(array("\t","\n","\r"),"",$value)); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
	}

	protected function _trim_print_string($value)
	{
   $this->debug("libraries-Grocery_CRUD-	protected function _trim_print_string(value)");
   $this->debug("libraries-Grocery_CRUD-	value = " . $value);
		$value = str_replace(array("&nbsp;","&amp;","&gt;","&lt;"), array(" ","&",">","<"), $value); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)

		//If the value has only spaces and nothing more then add the whitespace html character
		if(str_replace(" ", "", $value) == "") // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
			$value = "&nbsp;";
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function set_echo_and_die()");
		$this->echo_and_die = true;
	}

	protected function unset_echo_and_die()
	{
   $this->debug("libraries-Grocery_CRUD-protected function unset_echo_and_die()");
		$this->echo_and_die = false;
	}

	protected function showListInfo()
	{
   $this->debug("libraries-Grocery_CRUD-protected function showListInfo()");
		$this->set_echo_and_die();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function change_list_add_actions(list)");
   //$this->debug("libraries-Grocery_CRUD-list = " . $list);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function change_list(list, types)");
   //$this->debug("libraries-Grocery_CRUD-list = " . $list);
   //$this->debug("libraries-Grocery_CRUD-types = " . $types);
		$primary_key = $this->get_primary_key();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function showAddForm()");
    ...
    {
   $this->debug("libraries-Grocery_CRUD-protected function showCloneForm(state_info)");
   //$this->debug("libraries-Grocery_CRUD-state_info = " . $state_info);
        $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function showEditForm(state_info)");
   //$this->debug("libraries-Grocery_CRUD-state_info = " . $state_info);
		$this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function showReadForm(state_info)");
   //$this->debug("libraries-Grocery_CRUD-state_info = " . $state_info);
		$this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function delete_layout(delete_result = true)");
   $this->debug("libraries-Grocery_CRUD-delete_result = " . $delete_result);
		@ob_end_clean();
		if($delete_result === false)
		{
   ...
   $this->debug("libraries-Grocery_CRUD-protected function get_success_message_at_list(field_info = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function insert_layout(insert_result = false)");
		@ob_end_clean();
		if($insert_result === false)
		{
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function validation_layout(validation_result)");
   $this->debug("libraries-Grocery_CRUD-validation_result = " . $validation_result);
		@ob_end_clean();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function upload_layout(upload_result, field_name)");
   $this->debug("libraries-Grocery_CRUD-upload_result = " . $upload_result);
   $this->debug("libraries-Grocery_CRUD-field_name = " . $field_name);
		@ob_end_clean();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function delete_file_layout(upload_result)");
   $this->debug("libraries-Grocery_CRUD-upload_result = " . $upload_result);
		@ob_end_clean();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_css(css_file)");
   $this->debug("libraries-Grocery_CRUD-css_file = " . $css_file);
		$this->css_files[sha1($css_file)] = base_url().$css_file;
	}

	public function set_js($js_file)
	{
   $this->debug("libraries-Grocery_CRUD-public function set_js($js_file)");
		$this->js_files[sha1($js_file)] = base_url().$js_file;
	}

	public function set_js_lib($js_file)
	{
   $this->debug("libraries-Grocery_CRUD-public function set_js_lib($js_file)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_js_config($js_file)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function is_IE7()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function get_css_files()");
		return $this->css_files;
	}

	public function get_js_files()
	{
   $this->debug("libraries-Grocery_CRUD-public function get_js_files()");
		return $this->js_files;
	}

	public function get_js_lib_files()
	{
   $this->debug("libraries-Grocery_CRUD-public function get_js_lib_files()");
		return $this->js_lib_files;
	}

	public function get_js_config_files()
	{
   $this->debug("libraries-Grocery_CRUD-public function get_js_config_files()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function load_js_fancybox()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-libraries-Grocery_CRUD-protected function load_js_chosen()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-libraries-Grocery_CRUD-protected function load_js_jqueryui()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function load_js_uploader()");
		$this->set_css($this->default_css_path.'/ui/simple/'.grocery_CRUD::JQUERY_UI_CSS);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_layout()");
	...
	{
   $this->debug("protected function update_layout(update_result = false, state_info = null)");
		@ob_end_clean();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_integer_input($field_info, $value)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_true_false_input($field_info, $value)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_string_input(field_info, value)");
   //$this->debug("libraries-Grocery_CRUD- field_info = " . $field_info); //KKK Error: Object of class stdClass could not be converted to string
   $this->debug("libraries-Grocery_CRUD- value = " . $value);
		$value = !is_string($value) ? '' : str_replace('"', "&quot;", $value); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)

		$extra_attributes = '';
		if (!empty($field_info->db_max_length)) {
   $this->debug("libraries-Grocery_CRUD- field_info->db_max_length = " . $field_info->db_max_length);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_text_input(field_info, value)");
   //$this->debug("libraries-Grocery_CRUD-field_info = " . $field_info); // kkk Error Object of class stdClass could not be converted to string
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_datetime_input(field_info, value)");
   //$this->debug("libraries-Grocery_CRUD-field_info = " . $field_info); //Error Object of class stdClass could not be converted to string
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
		$this->set_css($this->default_css_path.'/ui/simple/'.grocery_CRUD::JQUERY_UI_CSS);
		...
		if(!empty($value) && $value != '0000-00-00 00:00:00' && $value != '1970-01-01 00:00:00'){
			list($year,$month,$day) = explode('-',substr($value,0,10)); //list Asigna de array a variables
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_hidden_input(field_info, value)");
   //$this->debug("libraries-Grocery_CRUD-field_info = " . $field_info); // kkk Error Object of class stdClass could not be converted to string
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_password_input(field_info, value)");
   $this->debug("libraries-Grocery_CRUD-field_info = " . $field_info);
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_date_input(field_info, value)");
   $this->debug("libraries-Grocery_CRUD-field_info = " . $field_info);
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
		$this->set_css($this->default_css_path.'/ui/simple/'.grocery_CRUD::JQUERY_UI_CSS);
		$this->set_js_lib($this->default_javascript_path.'/jquery_plugins/ui/'.grocery_CRUD::JQUERY_UI_JS);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_dropdown_input(field_info, value)");
   $this->debug("field_info =" . $field_info);
   $this->debug("value =" . $value);
		$this->load_js_chosen();
		$this->set_js_config($this->default_javascript_path.'/jquery_plugins/config/jquery.chosen.config.js');

		$select_title = str_replace('{field_display_as}',$field_info->display_as,$this->l('set_relation_title')); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_enum_input(field_info, value)");
   //$this->debug("libraries-Grocery_CRUD-$field_info = " . $field_info); // kkk Error Object of class stdClass could not be converted to string
   $this->debug("libraries-Grocery_CRUD-$value = " . $value);
		$this->load_js_chosen();
		$this->set_js_config($this->default_javascript_path.'/jquery_plugins/config/jquery.chosen.config.js');
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_readonly_input(field_info, value)");
   //$this->debug("libraries-Grocery_CRUD-field_info )= " . $field_info); //Array to string conversion
   //$this->debug("libraries-Grocery_CRUD-value )= " . $value); //Array to string conversion
		$read_only_value = "&nbsp;";
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_set_input(field_info, value)");
   $this->debug("libraries-Grocery_CRUD-field_info = " . $field_info);
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
   if($field_info->extras !== false){
   $this->debug("libraries-Grocery_CRUD-field_info->extras = " . $$field_info->extras);
   }
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_multiselect_input(field_info, value)");
   $this->debug("libraries-Grocery_CRUD-field_info = " . $field_info);
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
		$this->load_js_chosen();
		$this->set_js_config($this->default_javascript_path.'/jquery_plugins/config/jquery.chosen.config.js');
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_relation_input(field_info, value)");
   //$this->debug("libraries-Grocery_CRUD-protected function get_relation_input(field_info, value) - field_info = " . $field_info);
   $this->debug("libraries-Grocery_CRUD- value = " . $value);
		$this->load_js_chosen();
		$this->set_js_config($this->default_javascript_path.'/jquery_plugins/config/jquery.chosen.config.js');

		$ajax_limitation = 10000;
   $this->debug("libraries-Grocery_CRUD- ajax_limitation = " . $ajax_limitation);
		$total_rows = $this->get_relation_total_rows($field_info->extras);
   $this->debug("libraries-Grocery_CRUD- total_rows = " . $total_rows);


		//Check if we will use ajax for our queries or just clien-side javascript
		$using_ajax = $total_rows > $ajax_limitation ? true : false;
   $this->debug("libraries-Grocery_CRUD- using_ajax = " . $using_ajax);
   ...
   $this->debug("libraries-Grocery_CRUD- ajax_or_not_class = " . $ajax_or_not_class);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_relation_readonly_input(field_info, value)");
   //$this->debug("libraries-Grocery_CRUD-field_info = " . $field_info);
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
		$options_array = $this->get_relation_array($field_info->extras);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_upload_file_readonly_input(field_info, value)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_relation_n_n_input(field_info_type, selected_values)");
		...
		else
		{
			...
			$select_title = str_replace('{field_display_as}',$field_info_type->display_as,$this->l('set_relation_title')); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _convert_bytes_ui_to_bytes(bytes_ui)");
		$bytes_ui = str_replace(' ','',$bytes_ui); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
		if(strstr($bytes_ui,'MB'))
			$bytes = (int)(str_replace('MB','',$bytes_ui))*1024*1024; // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
		elseif(strstr($bytes_ui,'KB'))
			$bytes = (int)(str_replace('KB','',$bytes_ui))*1024; // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
		elseif(strstr($bytes_ui,'B'))
			$bytes = (int)(str_replace('B','',$bytes_ui)); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
		else
			$bytes = (int)($bytes_ui);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_upload_file_input(field_info, value)");
		...
		$allowed_files = $this->config->file_upload_allow_file_types;
		$allowed_files_ui = '.'.str_replace('|',',.',$allowed_files); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
		$max_file_size_ui = $this->config->file_upload_max_file_size;
		$max_file_size_bytes = $this->_convert_bytes_ui_to_bytes($max_file_size_ui);
		...
		$this->_inline_js('
			...
			var error_max_file_size 		= "'.str_replace("{max_file_size}",$max_file_size_ui,$this->l('error_max_file_size')).'"; // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_add_hidden_fields()");
		return $this->add_hidden_fields;
	}

	protected function get_edit_hidden_fields()
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_edit_hidden_fields()");
		return $this->edit_hidden_fields;
	}

	protected function get_add_input_fields($field_values = null)
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_add_input_fields(field_values = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_edit_input_fields(field_values = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_read_input_fields(field_values = null)");
		$read_fields = $this->get_read_fields();
   //$this->debug("libraries-Grocery_CRUD-001- read_fields = " . $read_fields); //Error Array to string conversion
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function setThemeBasics()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_theme(theme = null)");
		$this->theme = $theme;
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _get_ajax_results()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _is_ajax()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _theme_view(view, vars = array(), return = FALSE)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _inline_js(inline_js = '')");
		$this->views_as_string .= "<script type=\"text/javascript\">\n{$inline_js}\n</script>\n";
   $this->debug("libraries-Grocery_CRUD-protected function _inline_js(inline_js = '') - this->views_as_string = " . $this->views_as_string);
	}

	protected function _add_js_vars($js_vars = array())
	{
   $this->debug("libraries-Grocery_CRUD-protected function _add_js_vars(js_vars = array())");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_views_as_string()");
 ...
 * @version    	1.6.1
 */
class grocery_CRUD_States extends grocery_CRUD_Layout // class0
{
    ...
    {
   $this->debug("libraries-Grocery_CRUD-public function getStateInfo()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function getStateCode()");
   ...
   $this->debug("libraries-Grocery_CRUD - state_code = " . $state_code);
      }
		else {
			$state_code = 0;
   $this->debug("libraries-Grocery_CRUD - state_code = " . $state_code);
   ...
   $this->debug("libraries-Grocery_CRUD - state_code = " . $state_code);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function state_url(url = '', is_list_page = false)");
   $this->debug("libraries-Grocery_CRUD-$url = " . $url);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_state_info_from_url()");
		$ci = &get_instance();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_method_hash()");
		$ci = &get_instance();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_method_name()");
		$ci = &get_instance();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_controller_name()");
		$ci = &get_instance();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function getState()");
		return $this->states[$this->getStateCode()];
	}

	protected function getListUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getListUrl()");
		return $this->state_url('',true);
	}

	protected function getAjaxListUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getAjaxListUrl()");
		return $this->state_url('ajax_list');
	}

	protected function getExportToExcelUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getExportToExcelUrl()");
		return $this->state_url('export');
	}

	protected function getPrintUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getPrintUrl()");
		return $this->state_url('print');
	}

	protected function getAjaxListInfoUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getAjaxListInfoUrl()");
		return $this->state_url('ajax_list_info');
	}

	protected function getAddUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getAddUrl()");
		return $this->state_url('add');
	}

	protected function getInsertUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getInsertUrl()");
		return $this->state_url('insert');
	}

	protected function getValidationInsertUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getValidationInsertUrl()");
		return $this->state_url('insert_validation');
	}

	protected function getValidationUpdateUrl($primary_key = null)
	{
   $this->debug("libraries-Grocery_CRUD-protected function getValidationUpdateUrl(primary_key = null)");
		if($primary_key === null)
    ...
    {
   $this->debug("libraries-Grocery_CRUD-protected function getCloneUrl(primary_key = null)");
        if ($primary_key === null) {
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function getEditUrl(primary_key = null)");
		if($primary_key === null)
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function getReadUrl(primary_key = null)");
		if($primary_key === null)
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function getUpdateUrl(state_info)");
		return $this->state_url('update/' . $state_info->primary_key);
	}

	protected function getDeleteUrl($state_info = null)
	{
   $this->debug("libraries-Grocery_CRUD-protected function getDeleteUrl(state_info = null)");
		if (empty($state_info)) {
    ...
    {
   $this->debug("libraries-Grocery_CRUD-protected function getDeleteMultipleUrl()");
        return $this->state_url('delete_multiple');
    }

	protected function getListSuccessUrl($primary_key = null)
	{
   $this->debug("libraries-Grocery_CRUD-protected function getListSuccessUrl(primary_key = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function getUploadUrl(field_name)");
		return $this->state_url('upload_file/' . $field_name);
	}

	protected function getFileDeleteUrl($field_name)
	{
   $this->debug("libraries-Grocery_CRUD-protected function getFileDeleteUrl(field_name)");
		return $this->state_url('delete_file/' . $field_name);
	}

	protected function getAjaxRelationUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getAjaxRelationUrl()");
		return $this->state_url('ajax_relation');
	}

	protected function getAjaxRelationManytoManyUrl()
	{
   $this->debug("libraries-Grocery_CRUD-protected function getAjaxRelationManytoManyUrl()");
 ...
 * @link		http://www.grocerycrud.com/documentation
 */
class Grocery_CRUD extends grocery_CRUD_States // class0
{
	/**
...
public function debug($lin_debug){
   ...
   fclose($fp); //Cierra identificador del fichero abierto
	...
	{
   $this->debug("libraries-Grocery_CRUD-Constructor vacio - public function __construct()");
	}
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function columns()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-function set_rules(field, label = '', rules = '', errors = array())");
   $this->debug("libraries-Grocery_CRUD-field = " . $field);
   $this->debug("libraries-Grocery_CRUD-label = " . $label);
   $this->debug("libraries-Grocery_CRUD-rules = " . $rules);
		if(is_string($field))
		{
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function change_field_type(field , type, extras = null)");
   $this->debug("libraries-Grocery_CRUD-field = " . $field);
   $this->debug("libraries-Grocery_CRUD-type = " . $type);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function field_type(field , type, extras = null)");
   $this->debug("libraries-Grocery_CRUD-field = " . $field);
   $this->debug("libraries-Grocery_CRUD-type = " . $type);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_primary_key(primary_key_field, table_name = null)");
   $this->debug("libraries-Grocery_CRUD-primary_key_field = " . $primary_key_field);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_texteditor()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_jquery()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_jquery_ui()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_bootstrap()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_add()");
		$this->unset_add = true;
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_edit()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_delete()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_read()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_view()");
		return unset_read();
	}
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_export()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_print()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_operations()");
		$this->unset_add 	= true;
		$this->unset_edit 	= true;
        $this->unset_clone = true;
		$this->unset_delete = true;
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_columns()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_list()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_add_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_edit_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_clone_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_read_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unset_back_to_list()");
    ...
    {
   $this->debug("libraries-Grocery_CRUD-public function unset_clone()");
        $this->unset_clone = true;
    ...
    {
   $this->debug("libraries-Grocery_CRUD-public function set_clone()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function add_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function edit_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_read_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function display_as(field_name, display_as = null)");
   $this->debug("libraries-Grocery_CRUD-field_name = $field_name = " . $field_name);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _load_language()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _load_date_format()");
		list($php_day, $php_month, $php_year) = array('d', 'm', 'Y'); //list Asigna de array a variables
		list($js_day, $js_month, $js_year) = array('dd', 'mm', 'yy'); //list Asigna de array a variables
		list($ui_day, $ui_month, $ui_year) = array($this->l('ui_day'), $this->l('ui_month'), $this->l('ui_year')); //list Asigna de array a variables
   ...
   $this->debug("libraries-Grocery_CRUD-public function set_lang_string($handle, $lang_string)");
		$this->lang_strings[$handle] = $lang_string;
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function l(handle)");
   $this->debug("libraries-Grocery_CRUD-handle = " . $handle);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function get_lang_string($handle)");
   $this->debug("libraries-Grocery_CRUD-handle = " . $handle);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_language(language)");
   $this->debug("libraries-Grocery_CRUD-language = " . $language);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_columns()");
		if($this->columns_checked === false)
		{
			...
			foreach($this->columns as $col_num => $column)
			{
				...
				if(isset($this->relation[$column]))
				{
					...
					{
						$this->display_as[$new_column] = ucfirst(str_replace('_',' ',$column)); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
					}
				...
				elseif(isset($field_types[$column]))
					...
					$this->columns[$col_num] = (object)array('field_name' => $column, 'display_as' =>
						ucfirst(str_replace('_',' ',$column))); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_add_fields()");
			...
			if(!empty($this->add_fields))
			{
				foreach($this->add_fields as $field_num => $field)
				{
					...
					elseif(isset($field_types[$field]->display_as))
						...
						$this->add_fields[$field_num] = (object)array('field_name' => $field, 'display_as' => ucfirst(str_replace('_',' ',$field))); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)
				}
			}
			else
			{
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_edit_fields()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_read_fields()");
		if($this->read_fields_checked === false)
		{
			$field_types = $this->get_field_types();
			if(!empty($this->read_fields))
			{
   $this->debug("libraries-Grocery_CRUD-protected function get_read_fields()-001");
				foreach($this->read_fields as $field_num => $field)
				{
                  ...
                  $this->debug("libraries-Grocery_CRUD-protected function get_read_fields() - this->display_as[field] = " . $this->display_as[$field]);
					}
					else{
						$this->read_fields[$field_num] = (object)array('field_name' => $field, 'display_as' => $field_types[$field]->display_as);
                  $this->debug("libraries-Grocery_CRUD-protected function get_read_fields() - field_types[field]->display_as = " . $field_types[$field]->display_as);
					}
				} //foreach
			}
			else
			{
   $this->debug("libraries-Grocery_CRUD-protected function get_read_fields()-002");
   ...
   $this->debug("libraries-Grocery_CRUD-protected function get_read_fields() - field->name = " . $field->name);

					if(!isset($field->db_extra) || $field->db_extra != 'auto_increment')
					{
   $this->debug("libraries-Grocery_CRUD-protected function get_read_fields()-003");
						if(isset($this->display_as[$field->name])) {
							$this->read_fields[] = (object)array('field_name' => $field->name, 'display_as' => $this->display_as[$field->name]);
                     $this->debug("libraries-Grocery_CRUD-protected function get_read_fields()- this->display_as[field->name] = " . $this->display_as[$field->name]);
						}
						else{
							$this->read_fields[] = (object)array('field_name' => $field->name, 'display_as' => $field->display_as);
                     $this->debug("libraries-Grocery_CRUD-protected function get_read_fields()- field->display_as = " . $field->display_as);
						}
					}
				} //foreach
			}
			...
			$this->read_fields_checked = true;
                     $this->debug("libraries-Grocery_CRUD-protected function get_read_fields()- this->read_fields_checked = " . $this->read_fields_checked);
		}
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function order_by(order_by, direction = 'asc')");
   $this->debug("libraries-Grocery_CRUD-order_by = " . $order_by);
   $this->debug("libraries-Grocery_CRUD-direction = " . $direction);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function where(key, value = NULL, escape = TRUE)");
   $this->debug("libraries-Grocery_CRUD-key = " . $key);
   $this->debug("libraries-Grocery_CRUD-escape = " . $escape);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function or_where(key, value = NULL, escape = TRUE)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function like(field, match = '', side = 'both')");
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function having(key, value = '', escape = TRUE)");
   $this->debug("libraries-Grocery_CRUD-key = " . $key);
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
   $this->debug("libraries-Grocery_CRUD-escape = " . $escape);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function or_having(key, value = '', escape = TRUE)");
   $this->debug("libraries-Grocery_CRUD-key = " . $key);
   $this->debug("libraries-Grocery_CRUD-value = " . $value);
   $this->debug("libraries-Grocery_CRUD-escape = " . $escape);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function or_like(field, match = '', side = 'both')");
   $this->debug("libraries-Grocery_CRUD-field = " . $field);
   $this->debug("libraries-Grocery_CRUD-match = " . $match);
   $this->debug("libraries-Grocery_CRUD-both = " . $both);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function limit(limit, offset = '')");
   $this->debug("libraries-Grocery_CRUD-limit = " . $limit);
   $this->debug("libraries-Grocery_CRUD-offset = " . $offset);
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _initialize_helpers()");
		$ci = &get_instance();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _initialize_variables()");
		$ci = &get_instance();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function _set_primary_keys_to_model()");
		if(!empty($this->primary_keys))
		{
   $this->debug("libraries-Grocery_CRUD-protected function _set_primary_keys_to_model()-001");
			foreach($this->primary_keys as $primary_key)
			{
				$this->basic_model->set_primary_key($primary_key['field_name'], $primary_key['table_name']);
            $this->debug("libraries-Grocery_CRUD-protected function _set_primary_keys_to_model() - primary_key['field_name'] = " . $primary_key['field_name']);
            $this->debug("libraries-Grocery_CRUD-protected function _set_primary_keys_to_model() - primary_key['table_name'] = " . $primary_key['table_name']);
			}
		}
	}
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function pre_render()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function render()");
		$this->pre_render();

		if( $this->state_code != 0 )
		{
   $this->debug("libraries-Grocery_CRUD-public function render()-001");
			$this->state_info = $this->getStateInfo();
		}
		else
		{
   $this->debug("libraries-Grocery_CRUD-public function render()-002");
			throw new Exception('The state is unknown , I don\'t know what I will do with your data!', 4);
			die();
		}

   $this->debug("libraries-Grocery_CRUD-public function render()-003- this->state_code = " . $this->state_code);

		switch ($this->state_code) {
			case 15://success
			case 1://list
   $this->debug("libraries-Grocery_CRUD-public function render()-004");
				if($this->unset_list)
				{
   $this->debug("libraries-Grocery_CRUD-public function render()-005");
					throw new Exception('You don\'t have permissions for this operation', 14);
					die();
				}

				if($this->theme === null){
   $this->debug("libraries-Grocery_CRUD-public function render()-006");
   ...
   $this->debug("libraries-Grocery_CRUD-public function render()-007");
			break;

			case 2://add
   $this->debug("libraries-Grocery_CRUD-public function render()-008");
				if($this->unset_add)
				{
					throw new Exception('You don\'t have permissions for this operation', 14);
					die();
	...
	{
   $this->debug("libraries-Grocery_CRUD-protected function get_common_data()");
		$data = (object)array();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_before_insert(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_after_insert(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_insert(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_before_update($callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_after_update(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_update(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_before_delete(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_after_delete(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_delete(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_before_clone(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_after_clone(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_clone(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_column(column, callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_field(field, callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_add_field(field, callback = null)");
		$this->callback_add_field[$field] = $callback;
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_edit_field(field, callback = null)");
		$this->callback_edit_field[$field] = $callback;
    ...
    {
   $this->debug("libraries-Grocery_CRUD-public function callback_read_field(field, callback = null)");
        $this->callback_read_field[$field] = $callback;
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_upload(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_before_upload(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function callback_after_upload(callback = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function get_table()");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function required_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function unique_fields()");
		$args = func_get_args();
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_table(table_name)");
   $this->debug("libraries-Grocery_CRUD-table_name = " . $table_name);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_crud_url_path(crud_url_path, list_url_path = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_subject(subject, subject_plural = null)");
   $this->debug("libraries-Grocery_CRUD-subject = " . $subject);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function add_action(label, image_url = '', link_url = '', css_class = '', url_callback = null)");
   $this->debug("libraries-Grocery_CRUD-label = " . $label);
   $this->debug("libraries-Grocery_CRUD-image_url = " . $image_url);
   $this->debug("libraries-Grocery_CRUD-link_url = " . $link_url);
   $this->debug("libraries-Grocery_CRUD-css_class = " . $css_class);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_relation(field_name , related_table, related_title_field, where_clause = null, order_by = null)");
   $this->debug("libraries-Grocery_CRUD-public function set_relation-field_name = " . $field_name);
   $this->debug("libraries-Grocery_CRUD-public function set_relation-related_table = " . $related_table);
   $this->debug("libraries-Grocery_CRUD-public function set_relation-related_title_field = " . $related_title_field);
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_relation_n_n($field_name, $relation_table, $selection_table, $primary_key_alias_to_this_table, $primary_key_alias_to_selection_table , $title_field_selection_table , $priority_field_relation_table = null, $where_clause = null)");
	...
	{
   $this->debug("libraries-Grocery_CRUD-public function set_field_upload($field_name, $upload_dir = '', $allowed_file_types = '')");
...
public function debug($lin_debug){
   ...
   fclose($fp); //Cierra identificador del fichero abierto
    ...
    {
   $this->debug("libraries-Grocery_CRUD-Construct function __construct($options=null)");
        $this->options = array(
    ...
    function getFullUrl() {
    $this->debug("libraries-Grocery_CRUD-function getFullUrl()");
     	return
   ...
   $this->debug("libraries-Grocery_CRUD-private function get_file_object(file_name)");
   $this->debug("libraries-Grocery_CRUD-file_name = " . $file_name);
   ...
   $this->debug("libraries-Grocery_CRUD-private function get_file_objects()");
   ...
   $this->debug("libraries-Grocery_CRUD-private function create_scaled_image(file_name, options)");
   $this->debug("libraries-Grocery_CRUD-file_name = " . $file_name);
   $this->debug("libraries-Grocery_CRUD-options = " . $options);
        $file_path = $this->options['upload_dir'].$file_name;
        $new_file_path = $options['upload_dir'].$file_name;
        list($img_width, $img_height) = @getimagesize($file_path); //list Asigna de array a variables
   ...
   $this->debug("libraries-Grocery_CRUD-private function has_error(uploaded_file, file, error)");
   $this->debug("libraries-Grocery_CRUD-uploaded_file = " . $uploaded_file);
   $this->debug("libraries-Grocery_CRUD-file = " . $file);
   $this->debug("libraries-Grocery_CRUD-error = " . $error);
        if ($error) {
			switch($error) {
   ...
   $this->debug("libraries-Grocery_CRUD-private function trim_file_name(name, type)");
   $this->debug("libraries-Grocery_CRUD-name = " . $name);
   $this->debug("libraries-Grocery_CRUD-type = " . $type);
   ...
   $this->debug("libraries-Grocery_CRUD-file_name = " . $file_name);
	...
	{
   $this->debug("libraries-Grocery_CRUD-private function _transliterate_characters(file_name)");
   $this->debug("libraries-Grocery_CRUD-file_name = " . $file_name);
		...
		$file_name = str_replace(" ", "-", $file_name); // str_replace(String_a_buscar_Array, String_sustituye_Array, String_base)

		return preg_replace('/\-+/', '-', trim($file_name, '-'));
	}

    private function orient_image($file_path) {
   $this->debug("libraries-Grocery_CRUD-private function orient_image(file_path)");
   $this->debug("libraries-Grocery_CRUD-file_path = " . $file_path);
   ...
   $this->debug("libraries-Grocery_CRUD-private function handle_file_upload(uploaded_file, name, size, type, error)");
   $this->debug("libraries-Grocery_CRUD-uploaded_file = " . $uploaded_file);
   $this->debug("libraries-Grocery_CRUD-name = " . $name);
   $this->debug("libraries-Grocery_CRUD-size = " . $size);
   $this->debug("libraries-Grocery_CRUD-type = " . $type);
   $this->debug("libraries-Grocery_CRUD-error = " . $error);
        $file = new stdClass();
    ...
    public function get() {
   $this->debug("libraries-Grocery_CRUD-public function get()");
   ...
   $this->debug("libraries-Grocery_CRUD-public function post()");
    ...
    {
   $this->debug("libraries-Grocery_CRUD-public function delete()");
        $file_name = isset($_REQUEST['file']) ?
            basename(stripslashes($_REQUEST['file'])) : null;
        $file_path = $this->options['upload_dir'] . $file_name;
